...
typedef runtime_status_t (*allocator_ctl_fn_t)(void* self,
                                               allocator_command_t command,
                                               const void* params,
                                               void** inout_ptr);
...
#else
extern runtime_status_t ALLOCATOR_SYSTEM_CTL(void* self,
                                             allocator_command_t command,
                                             const void* params,
                                             void** inout_ptr);
#endif

static inline allocator_t allocator_system(void) {
