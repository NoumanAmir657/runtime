...
void test_malloc_free() {
    ...
    ASSERT_OK(allocator.ctl(allocator.self, ALLOCATOR_COMMAND_MALLOC, &params, &ptr));
    ASSERT_NOT_NULL(ptr);
...
void test_calloc() {
    ...
    ASSERT_OK(allocator.ctl(allocator.self, ALLOCATOR_COMMAND_CALLOC, &params, &ptr));
    ASSERT_NOT_NULL(ptr);
...
void test_realloc() {
    ...
    ASSERT_OK(allocator.ctl(allocator.self, ALLOCATOR_COMMAND_REALLOC, &params, &ptr));
    ASSERT_NOT_NULL(ptr);
...
void test_oom_behavior() {
    allocator_t allocator = allocator_system();
    allocator_alloc_params_t params = { .number_of_bytes = SIZE_MAX };
    void* ptr = NULL;

    ASSERT_ERROR(allocator.ctl(allocator.self, ALLOCATOR_COMMAND_MALLOC, &params, &ptr),
